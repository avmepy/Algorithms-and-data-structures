...
def SelectionSort(items, key=lambda _: _, reverse=False):
    """
...
if __name__ == '__main__':
    ...
    print(SelectionSort(t2, key=lambda string: len(string)))  # sort by line length
    # sort by the sum of the numeric representations of the characters in a string
    print(SelectionSort(t2, key=lambda string: sum([ord(i) for i in string])))